...
class Data(val context: Context) {
    fun mainMenuData(): ArrayList<MainEntity> {
        ...
        menus.add(
            MainEntity(
                id = "1",
                title = String.format(context.resources.getString(R.string.plant_disease), context.resources.getString(R.string.corn)),
                model = "corn",
        ...
        menus.add(
            MainEntity(
                id = "2",
                title = String.format(context.resources.getString(R.string.plant_disease), context.resources.getString(R.string.tomato)),
                model = "tomato",
        ...
        menus.add(
            MainEntity(
                id = "3",
                title = String.format(context.resources.getString(R.string.plant_disease), context.resources.getString(R.string.potato)),
                model = "potato",
